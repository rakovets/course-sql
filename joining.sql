...
INSERT trainer(trainer_id, firstname, lastname, birthdate, department, phone) VALUES (1, 'Sophia', 'Nelson', '1984-12-08', 'Software development', '32-12');
INSERT trainer(trainer_id, firstname, lastname, birthdate, department, phone) VALUES (2, 'Emma', 'Kirk', '1973-05-12', 'Mathematics', '55-34');
INSERT trainer(trainer_id, firstname, lastname, birthdate, department, phone) VALUES (3, 'Henry', 'MacAlister', '1975-02-17', 'Software development', '32-12');
INSERT trainer(trainer_id, firstname, lastname, birthdate, department, phone) VALUES (4, 'Michael', 'Cooper', '1978-11-23', 'Software development', '32-12');
INSERT trainer(trainer_id, firstname, lastname, birthdate, department, phone) VALUES (5, 'Daniel', 'Williams', '1979-07-30', 'Cybersecurity', '37-65');
INSERT trainer(trainer_id, firstname, lastname, birthdate, department, phone) VALUES (6, 'Sophia', 'Nelson', '1984-12-08', 'Software development', '32-12');
INSERT trainer(trainer_id, firstname, lastname, birthdate, department, phone) VALUES (7, 'Daniel', 'Williams', '1979-07-30', 'Cybersecurity', '37-65');
...
INSERT subject (subject_id, name) VALUES (8, 'HighLoad');
...
INSERT student_group (group_id, name, faculty_id) VALUES (6, '33GR12', 3);
...
INSERT student (student_id, firstname, lastname, birthdate, student_grant, email, group_id) VALUES (10, 'Charlotte', 'Becker', '1998-02-11', NULL, 'cb@net.eu', null);

INSERT achievement(achievement_id, student_id, subject_id, assessment) VALUES (1, 1, 1, 10);
INSERT achievement(achievement_id, student_id, subject_id, assessment) VALUES (2, 2, 2, 10);
INSERT achievement(achievement_id, student_id, subject_id, assessment) VALUES (3, 3, 3, 7);
INSERT achievement(achievement_id, student_id, subject_id, assessment) VALUES (4, 1, 2, 10);
INSERT achievement(achievement_id, student_id, subject_id, assessment) VALUES (5, 5, 7, 5);
