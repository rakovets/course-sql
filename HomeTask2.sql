...
(NULL, 30000, 'SOCIAL STUDIES'),
(NULL, 27000, 'ZORO'),
(NULL, 28000, 'SOFTWARE DEVELOPMENT'),
...
(NULL, 'Henry', 'Ford', 800, 100, '2003-12-12', 1, 0, 'Assistent'),
...
SELECT surname
FROM teacher
WHERE salary + premium <= 1200 AND is_assistant = 1;

SELECT name
FROM group_student
WHERE year = 5 AND raiting BETWEEN 2 AND 4;

SELECT surname
FROM teacher
WHERE salary < 550 or premium < 200 AND is_assistant = 1;